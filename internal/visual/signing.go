...
func visualEditSigningSecret(a *app.App) (string, error) {
...
// it. Embedding the generation (store.VisualSite.TokenGeneration, bumped by
...
// grid edit does.
func generateEditToken(a *app.App, siteID, generation, issuerUserID int64) (string, error) {
	secret, err := visualEditSigningSecret(a)
	if err != nil {
		return "", err
	}
...
func verifyEditToken(a *app.App, token string, siteID, generation int64) (issuerUserID int64, ok bool, err error) {
